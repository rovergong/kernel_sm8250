...
TOOLCHAIN_PATH=$HOME/zyc_clang-14/bin
...
if [ $KSU_ENABLE -eq 1 ]; then
    echo "KSU is enabled"
    curl -LSsk "https://raw.github.com/ReSukiSU/ReSukiSU/main/kernel/setup.sh" | bash
else
    echo "KSU is disabled"
fi

#echo "Integrating Baseband-guard..."
#curl -LSsk "https://github.com/vc-teahouse/Baseband-guard/raw/main/setup.sh" | bash
...
if [ $KSU_ENABLE -eq 1 ]; then
    ...
    wget --no-check-certificate https://github.com/SukiSU-Ultra/SukiSU_KernelPatch_patch/releases/download/0.13.0/patch_linux
    chmod +x patch_linux
    ./patch_linux
    rm Image
    mv oImage Image
